									...
									<div class="product-grid-content">
										<div class="product-card--body">
											...
											<div class="product-header">
												<a class="author" href="product_details.php"><?php echo $row['book_title']; ?></a>
											...
											<div class="price-block">
												<span class="price">৳ <?php echo $row['new_price']; ?></span>
												<del class="price-old">৳ <?php echo $row['old_price']; ?></del>
												<span class="price-discount"><?php echo $row['discount']; ?>%</span>
											</div>
										</div>
									</div>
